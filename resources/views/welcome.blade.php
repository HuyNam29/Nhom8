   ...
   <div class="d-block">
         ...
         <div class="modal-content setting animate__animated animate__zoomIn" >
            ...
            <div class="d-inline-block position-relative suggest" >
               <div class="d-inline-block text-black">
                  <a href="#"><img src="{{ pare_url_file($list->avatar,'user') }}" class="rounded-circle">
                  {{ $list->user}}
               </a>
      ...
      @endif
            ...
            <article class="border-gray position-relative">
               <div class="header ">
                  <a class="text-black" href=""><img src="{{ pare_url_file(\Auth::user()->avatar,'user') }}" class="rounded-circle  d-inline-block img-user">{{ \Auth::user()->c_name}}</a>
               ...
               <div class="attractive">
                  <div class="d-block">
                     <div class="d-inline-block w-100">
                        <div class="status">
                           <a href="" class="text-black">{{\Auth::user()->c_name}} </a>{{$val->p_content}}    
                           <br>
                        </div>
                        <div class="hdl{{$key}}">
                           <div class="chat w-100 position-relative hjk" style="display:none">
                              <a href="" class="text-black">12314</a> ĐẸp
         ...
         <div class="d-block">
            ...
            <div class="about-us">
               <ul style="line-height:20px;margin-top: 30px;font-size:12px;opacity: 0.5;">
                  ...
                  <li class="d-inline-block "><a href="#">English</a>	&#8226;</li>
                  <li class="d-inline-block "><a href="#">Tiếng Việt</a></li>
               </ul>
               <br>
            </div>
